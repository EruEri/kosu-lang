...
and tac_statement =
  ...
  | STacModificationField of { identifier_root: string; fields: string list; trvalue : tac_typed_rvalue }
  | STDerefAffectation of { identifier : string; trvalue : tac_typed_rvalue }
  | STDerefAffectationField of { identifier_root: string; fields: string list; trvalue : tac_typed_rvalue }
  | STWhile of {
